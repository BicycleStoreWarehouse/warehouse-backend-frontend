...
func LoadExampleData(db *gorm.DB) {
	...
	worker_1, _ := models.CreateUser(db, "Jan", "Kowalski", "jan.kowalski@example.com", position_worker, twoYearsAgo, "123456789", "hashed_password1")
	worker_2, _ := models.CreateUser(db, "Anna", "Nowak", "anna.nowak@example.com", position_worker, twoYearsAgo, "987654321", "hashed_password2")
	worker_3, _ := models.CreateUser(db, "Piotr", "Wiśniewski", "piotr.wisniewski@example.com", position_worker, twoYearsAgo, "555555555", "hashed_password3")
	worker_4, _ := models.CreateUser(db, "Kamil", "Zieliński", "kamil.zielinski@example.com", position_worker, twoYearsAgo, "666666666", "hashed_password4")
	worker_5, _ := models.CreateUser(db, "Marta", "Nowakowska", "marta.nowakowska@example.com", position_worker, twoYearsAgo, "777777777", "hashed_password5")

	models.CreateUser(db, "Kasia", "Wójcik", "kasia.wojcik@example.com", position_hr, threeYearsAgo, "444444444", "hashed_password6")
	models.CreateUser(db, "Tomasz", "Kamiński", "tomasz.kaminski@example.com", position_hr, threeYearsAgo, "333333333", "hashed_password7")
	models.CreateUser(db, "Ewa", "Zielińska", "ewa.zielinska@example.com", position_hr, threeYearsAgo, "222222222", "hashed_password8")
	models.CreateUser(db, "Karolina", "Wiśniewska", "karolina.wisniewska@example.com", position_hr, threeYearsAgo, "888888888", "hashed_password9")
	models.CreateUser(db, "Łukasz", "Kowal", "lukasz.kowal@example.com", position_hr, threeYearsAgo, "999999999", "hashed_password10")
